...
class VectorStore:
    ...
    def create_index(self) -> None:
        """Create the ivfflat index to speed up similarity search if it doesn't exist."""
        try:
            self.vec_client.create_embedding_index(client.IvfflatIndex())
            logging.info(f"Created Ivfflat index for {self.vector_settings.table_name}")
    ...
    def drop_index(self) -> None:
        """Drop the ivfflat index in the database."""
